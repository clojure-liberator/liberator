...
String responses are encoding into a bytestream according to the
charset.
...
Like with maps, there are a couple of representations for sequences:
...
Additional media types can be generated by different ways. You can
extend the map and sequence rendering as told above, you can return a
string, or return a ring response.

Say, e.g. you want to return "application/css". Your handler can
